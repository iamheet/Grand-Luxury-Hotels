...
# Training data for The Royal Stay hotel website
training_data = [
    {"question": "What is The Royal Stay?", "answer": "The Royal Stay is a luxury hotel booking platform offering premium accommodations and instant access to premium services."},
    ...
    {"question": "Is there a mobile app?", "answer": "Currently, The Royal Stay is available as a web application accessible from any device."},
...
for i in range(1000):
    for item in training_data:
        expanded_data.append({
            ...
            "answer": item["answer"],
            "context": "The Royal Stay - Luxury Hotel Booking"
        })

with open("hotel-training-data.json", "w") as f:
    json.dump(expanded_data, f, indent=2)

print(f"Generated {len(expanded_data)} Q&A pairs for The Royal Stay")
